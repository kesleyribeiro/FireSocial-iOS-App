...
@objc public protocol UITextFieldNavigationDelegate: UITextFieldDelegate {
     ...
     */
    @objc optional func textFieldNavigationDidTapPreviousButton(textField: UITextField)
    ...
    /**
     ...
     - Parameter textField: the text field whose `inputAccessoryView`'s button was tapped.
     */
    @objc optional func textFieldNavigationDidTapNextButton(textField: UITextField)
    ...
    /**
     ...
     - Parameter textField: the text field whose `inputAccessoryView`'s button was tapped.
     */
    @objc optional func textFieldNavigationDidTapDoneButton(textField: UITextField)
}
